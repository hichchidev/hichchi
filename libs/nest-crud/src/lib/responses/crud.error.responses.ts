import { IEntityErrorResponse } from "@hichchi/nest-core";
...
const EntityErrors = {
    ...
    E_400_QUERY: (entityName: string, field?: string, description?: string): IEntityErrorResponse => ({
        status: 400,
    ...
    E_500_OPERATION: (entityName: string, operation: Operation, description?: string): IEntityErrorResponse => ({
        status: 500,
